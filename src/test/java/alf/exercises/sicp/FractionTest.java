...
public class FractionTest {
    ...
    public void testToDouble() {
        assertEquals(0.5d, f1.toDouble(), 0.001d);
    }
    ...
    public void testAdd() {
        ...
        assertEquals(1.1666d, f3.toDouble(), 0.0001d);

        Fraction f32 = f2.add(f1);
        assertEquals("7/6", f32.toString());
        assertEquals(1.1666d, f32.toDouble(), 0.0001d);
    }
    ...
    public void testSubtract() {
        ...
        assertEquals(0.1666d, f4.toDouble(), 0.0001d);

        Fraction f44 = f1.subtract(f2);
        assertEquals("-1/6", f44.toString());
        assertEquals(-0.1666d, f44.toDouble(), 0.0001d);
    }

    @Test
    public void testMultiply() {
        Fraction f5 = f1.multiply(f2);
        assertEquals("1/3", f5.toString());
        f5.pretty();
    }
...
//        assertEquals("1/2", new Fraction(20, 40).toString());
        assertEquals("31/17", new Fraction(31, 17).toString());
